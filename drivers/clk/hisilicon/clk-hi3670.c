...
static const struct hisi_gate_clock hi3670_crgctrl_gate_clks[] = {
	{ HI3670_AUTODIV_SYSBUS, "autodiv_sysbus", "clk_div_sysbus",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x404, 5, CLK_GATE_HIWORD_MASK, },
	{ HI3670_AUTODIV_EMMC0BUS, "autodiv_emmc0bus", "autodiv_sysbus",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x404, 1, CLK_GATE_HIWORD_MASK, },
	{ HI3670_PCLK_ANDGT_MMC1_PCIE, "pclk_andgt_mmc1_pcie", "clk_div_320m",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xf8, 13, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_GATE_VCODECBUS_GT, "clk_gate_vcodecbus_gt", "clk_mux_vcodecbus",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x0F0, 8, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_SD, "clk_andgt_sd", "clk_mux_sd_pll",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 3, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_SD_SYS_GT, "clk_sd_sys_gt", "clkin_sys",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 5, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_SDIO, "clk_andgt_sdio", "clk_mux_sdio_pll",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 8, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_SDIO_SYS_GT, "clk_sdio_sys_gt", "clkin_sys",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 6, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_A53HPM_ANDGT, "clk_a53hpm_andgt", "clk_mux_a53hpm",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x0F4, 7, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_320M_PLL_GT, "clk_320m_pll_gt", "clk_mux_320m",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF8, 10, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_UARTH, "clk_andgt_uarth", "clk_div_320m",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 11, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_UARTL, "clk_andgt_uartl", "clk_div_320m",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 10, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_UART0, "clk_andgt_uart0", "clk_div_320m",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 9, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_SPI, "clk_andgt_spi", "clk_div_320m",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 13, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_PCIEAXI, "clk_andgt_pcieaxi", "clk_mux_pcieaxi",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xfc, 15, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_DIV_AO_ASP_GT, "clk_div_ao_asp_gt", "clk_mux_ao_asp",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 4, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_GATE_CSI_TRANS, "clk_gate_csi_trans", "clk_ppll2",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 14, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_GATE_DSI_TRANS, "clk_gate_dsi_trans", "clk_ppll2",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF4, 1, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_PTP, "clk_andgt_ptp", "clk_div_320m",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF8, 5, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_OUT0, "clk_andgt_out0", "clk_ppll0",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF0, 10, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_OUT1, "clk_andgt_out1", "clk_ppll0",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF0, 11, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLKGT_DP_AUDIO_PLL_AO, "clkgt_dp_audio_pll_ao", "clk_ppll6",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF8, 15, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_VDEC, "clk_andgt_vdec", "clk_mux_vdec",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF0, 13, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_VENC, "clk_andgt_venc", "clk_mux_venc",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xF0, 9, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ISP_SNCLK_ANGT, "clk_isp_snclk_angt", "clk_div_a53hpm",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x108, 2, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_RXDPHY, "clk_andgt_rxdphy", "clk_div_a53hpm",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x0F0, 12, CLK_GATE_HIWORD_MASK, },
	{ HI3670_CLK_ANDGT_ICS, "clk_andgt_ics", "clk_mux_ics",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xf0, 14, CLK_GATE_HIWORD_MASK, },
	{ HI3670_AUTODIV_DMABUS, "autodiv_dmabus", "autodiv_sysbus",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x404, 3, CLK_GATE_HIWORD_MASK, },
};
...
static const struct hisi_gate_clock hi3670_pctrl_gate_clks[] = {
	{ HI3670_GATE_UFS_TCXO_EN, "clk_gate_ufs_tcxo_en", "clk_gate_abb_192",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x10, 0, CLK_GATE_HIWORD_MASK, },
	{ HI3670_GATE_USB_TCXO_EN, "clk_gate_usb_tcxo_en", "clk_gate_abb_192",
	  CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0x10, 1, CLK_GATE_HIWORD_MASK, },
};

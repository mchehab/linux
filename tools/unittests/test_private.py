...
TESTS = {
    ...
    "unbalanced struct_group_tagged with private": {
        "source": """
    ...
    "unbalanced two struct_group_tagged, first with private": {
        "source": """
            struct page_pool_params {
                struct_group_tagged(page_pool_params_slow, slow,
                        struct net_device *netdev;
    ...
    "unbalanced without end of line": {
        "source": """ \
            struct page_pool_params { \
                struct_group_tagged(page_pool_params_slow, slow, \
                        struct net_device *netdev; \
